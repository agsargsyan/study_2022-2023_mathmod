...
![траектории для случая 1](image/lab3om1.png){ #fig:001 width=60% height=60% } (рис. @fig:001)

Побеждает страна $X$.

## Результаты

![траектории для случая 2](image/lab3om2.png){ #fig:002 width=60% height=60% } (рис. @fig:002)
