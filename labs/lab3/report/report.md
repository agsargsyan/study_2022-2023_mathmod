...
![График численности на языке Julia](image/lab3julia01.png){ #fig:001 width=70% height=70% }

![График численности на OpenModelica](image/lab3om1.png){ #fig:002 width=70% height=70% }

Победа достается армии $X$.

## 2 случай

![График численности на языке Julia](image/lab3julia02.png){ #fig:003 width=70% height=70% }

![График численности на OpenModelica](image/lab3om2.png){ #fig:004 width=70% height=70% }
